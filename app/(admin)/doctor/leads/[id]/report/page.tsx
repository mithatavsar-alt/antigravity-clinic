...
function InfoRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex justify-between py-1.5 border-b border-[rgba(248,246,242,0.06)] print:border-[rgba(0,0,0,0.08)]">
      <span className="font-body text-[12px] text-[rgba(248,246,242,0.4)] print:text-[rgba(0,0,0,0.5)]">{label}</span>
...
export default function ReportPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="font-body text-[12px] text-[rgba(248,246,242,0.3)]">Rapor yükleniyor...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen print:bg-white">
      ...
      <div className="print:hidden sticky top-0 z-10 bg-[rgba(14,11,9,0.92)] backdrop-blur-md border-b border-[rgba(248,246,242,0.06)] px-6 py-3 flex items-center justify-between">
        <button
          onClick={() => router.back()}
          className="font-body text-[12px] text-[rgba(248,246,242,0.4)] hover:text-[#D6B98C] transition-colors"
        >
          ← Geri Dön
        </button>
        <button
          onClick={() => window.print()}
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[rgba(214,185,140,0.1)] border border-[rgba(214,185,140,0.2)] font-body text-[11px] tracking-[0.08em] uppercase text-[#D6B98C] hover:bg-[rgba(214,185,140,0.15)] transition-colors"
        >
      ...
      <div className="max-w-[800px] mx-auto px-8 py-10 print:px-0 print:py-6 print:max-w-none">
        {/* Header */}
        <div className="flex justify-between items-start mb-8 pb-6 border-b-2 border-[rgba(248,246,242,0.1)] print:border-[#1A1A2E]">
          <div>
          ...
          <div className="text-right">
            <p className="font-body text-[11px] text-[rgba(248,246,242,0.35)] print:text-[rgba(0,0,0,0.5)]">Rapor Tarihi</p>
            <p className="font-body text-[13px] text-[#F8F6F2] print:text-[#1A1A2E]">{formatDate(new Date().toISOString())}</p>
            <p className="font-mono text-[10px] text-[rgba(248,246,242,0.2)] mt-1 print:text-[rgba(0,0,0,0.4)]">ID: {lead.id.slice(0, 12)}</p>
          </div>
        </div>

        {/* Overall Score Hero — screen only */}
        {overallScore != null && (
          <div className="mb-8 rounded-xl border border-[rgba(248,246,242,0.06)] bg-[rgba(248,246,242,0.02)] p-6 flex items-center gap-6 print:border-[rgba(0,0,0,0.1)] print:bg-[rgba(0,0,0,0.02)]">
            <div className="flex-shrink-0 w-16 h-16 relative">
              <svg viewBox="0 0 64 64" className="w-full h-full -rotate-90">
                <circle cx="32" cy="32" r="28" fill="none" stroke="rgba(248,246,242,0.06)" strokeWidth="3" className="print:stroke-[rgba(0,0,0,0.08)]" />
            ...
            <div>
              <p className="font-body text-[9px] tracking-[0.15em] uppercase text-[rgba(248,246,242,0.3)] mb-1 print:text-[rgba(0,0,0,0.4)]">Genel Skor</p>
              <p className="font-body text-[13px] text-[rgba(248,246,242,0.6)] print:text-[rgba(0,0,0,0.6)]">
        ...
        <section className="mb-8">
          ...
          {lead.expectation_note && (
            <div className="mt-3 p-3 rounded-lg bg-[rgba(248,246,242,0.02)] border border-[rgba(248,246,242,0.06)] print:bg-[rgba(0,0,0,0.02)] print:border-[rgba(0,0,0,0.08)]">
              <p className="font-body text-[9px] text-[rgba(248,246,242,0.3)] uppercase tracking-[0.15em] mb-1 print:text-[rgba(0,0,0,0.4)]">Beklenti Notu</p>
              <p className="font-body text-[12px] text-[rgba(248,246,242,0.6)] leading-relaxed print:text-[rgba(0,0,0,0.7)]">{lead.expectation_note}</p>
            </div>
          )}
        </section>
        ...
        {aiScores && (
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div className="rounded-xl border border-[rgba(248,246,242,0.06)] bg-[rgba(248,246,242,0.02)] p-4 print:border-[rgba(0,0,0,0.1)] print:bg-transparent">
                <p className="font-body text-[9px] text-[rgba(248,246,242,0.3)] uppercase tracking-[0.15em] mb-2 print:text-[rgba(0,0,0,0.4)]">Simetri Skoru</p>
                <p className="font-mono text-[32px] font-light text-[#F8F6F2] print:text-[#1A1A2E]">
                  {aiScores.symmetry}<span className="text-[14px] text-[rgba(248,246,242,0.3)] print:text-[rgba(0,0,0,0.4)]">/100</span>
                </p>
              </div>
              <div className="rounded-xl border border-[rgba(248,246,242,0.06)] bg-[rgba(248,246,242,0.02)] p-4 print:border-[rgba(0,0,0,0.1)] print:bg-transparent">
                <p className="font-body text-[9px] text-[rgba(248,246,242,0.3)] uppercase tracking-[0.15em] mb-2 print:text-[rgba(0,0,0,0.4)]">Altın Oran Uyumu</p>
                <p className="font-mono text-[32px] font-light text-[#F8F6F2] print:text-[#1A1A2E]">
                  {aiScores.proportion}<span className="text-[14px] text-[rgba(248,246,242,0.3)] print:text-[rgba(0,0,0,0.4)]">/100</span>
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-0">
            ...
            {aiScores.suggestions.length > 0 && (
              <div className="mt-4">
                <p className="font-body text-[9px] text-[rgba(248,246,242,0.3)] uppercase tracking-[0.15em] mb-2 print:text-[rgba(0,0,0,0.4)]">Estetik Tespitler</p>
                <ul className="space-y-1.5">
                  {aiScores.suggestions.map((s: string, i: number) => (
                    <li key={i} className="font-body text-[12px] text-[rgba(248,246,242,0.55)] leading-relaxed flex gap-2 print:text-[rgba(0,0,0,0.7)]">
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2">
              {radarAnalysis.radarScores.map((r) => (
                <div key={r.key} className="flex items-center justify-between gap-3 py-1.5 border-b border-[rgba(248,246,242,0.04)] print:border-[rgba(0,0,0,0.06)]">
                  <span className="font-body text-[11px] text-[rgba(248,246,242,0.5)] print:text-[rgba(0,0,0,0.6)]">{r.label}</span>
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={title}>
                  <p className="font-body text-[11px] font-medium text-[rgba(248,246,242,0.45)] mb-2 print:text-[rgba(0,0,0,0.55)]">{title}</p>
                      ...
                      .map((key) => {
                        ...
                        return (
                          <div key={key} className="flex items-center justify-between gap-3">
                            <span className="font-body text-[11px] text-[rgba(248,246,242,0.4)] capitalize print:text-[rgba(0,0,0,0.5)]">
                              {key.replace(/_/g, ' ')}
                            </span>
                            <div className="flex items-center gap-2">
                              <div className="w-16 h-1.5 rounded-full bg-[rgba(248,246,242,0.06)] overflow-hidden print:bg-[rgba(0,0,0,0.06)]">
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              <div className="rounded-xl border border-[rgba(248,246,242,0.06)] bg-[rgba(248,246,242,0.02)] p-3 print:border-[rgba(0,0,0,0.1)] print:bg-transparent">
                <p className="font-body text-[9px] text-[rgba(248,246,242,0.3)] uppercase tracking-[0.15em] mb-1 print:text-[rgba(0,0,0,0.4)]">Risk Seviyesi</p>
              ...
              <div className="rounded-xl border border-[rgba(248,246,242,0.06)] bg-[rgba(248,246,242,0.02)] p-3 print:border-[rgba(0,0,0,0.1)] print:bg-transparent">
                <p className="font-body text-[9px] text-[rgba(248,246,242,0.3)] uppercase tracking-[0.15em] mb-1 print:text-[rgba(0,0,0,0.4)]">Doz Aralığı</p>
                <p className="font-body text-[14px] font-medium text-[#F8F6F2] print:text-[#1A1A2E]">{analysis.dose_recommendation.range_cc}</p>
              </div>
              <div className="rounded-xl border border-[rgba(248,246,242,0.06)] bg-[rgba(248,246,242,0.02)] p-3 print:border-[rgba(0,0,0,0.1)] print:bg-transparent">
                <p className="font-body text-[9px] text-[rgba(248,246,242,0.3)] uppercase tracking-[0.15em] mb-1 print:text-[rgba(0,0,0,0.4)]">Üst Limit</p>
          ...
          <section className="mb-8">
            ...
            <div className="flex items-center gap-6 mb-4">
              <div>
                ...
                <p className="font-body text-[9px] text-[rgba(248,246,242,0.3)] uppercase tracking-[0.15em] mt-1 print:text-[rgba(0,0,0,0.4)]">Skor</p>
              </div>
              <div>
                <p className="font-body text-[13px] font-medium text-[#F8F6F2] print:text-[#1A1A2E]">{readinessConfig?.label}</p>
                <p className="font-body text-[12px] text-[rgba(248,246,242,0.45)] print:text-[rgba(0,0,0,0.5)]">{readinessConfig?.action}</p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-0">
        ...
        {lead.doctor_notes && (
          <section className="mb-8">
            ...
            <div className="p-4 rounded-xl bg-[rgba(248,246,242,0.02)] border border-[rgba(248,246,242,0.06)] print:bg-[rgba(0,0,0,0.02)] print:border-[rgba(0,0,0,0.08)]">
              <p className="font-body text-[12px] text-[rgba(248,246,242,0.6)] leading-relaxed whitespace-pre-wrap print:text-[rgba(0,0,0,0.7)]">{lead.doctor_notes}</p>
              {lead.doctor_notes_updated_at && (
                <p className="font-mono text-[10px] text-[rgba(248,246,242,0.2)] mt-2 print:text-[rgba(0,0,0,0.4)]">{formatDateTime(lead.doctor_notes_updated_at)}</p>
              )}
            </div>
          </section>
        )}
        ...
        {/* Footer */}
        <div className="mt-12 pt-6 border-t border-[rgba(248,246,242,0.06)] print:border-[rgba(0,0,0,0.1)]">
          <div className="flex justify-between items-end">
            <div>
              <p className="font-body text-[10px] text-[rgba(248,246,242,0.3)] leading-relaxed print:text-[rgba(0,0,0,0.4)]">
            ...
            <div className="text-right">
              <p className="font-body text-[10px] text-[rgba(248,246,242,0.3)] print:text-[rgba(0,0,0,0.4)]">Dr. Müjde Ocak Aesthetic Clinic · AI</p>
              <p className="font-mono text-[9px] text-[rgba(248,246,242,0.2)] print:text-[rgba(0,0,0,0.3)]">v1.0.0 · {formatDate(new Date().toISOString())}</p>
            </div>
          </div>
        </div>
      </div>
