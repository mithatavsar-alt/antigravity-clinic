...
export function CTASection() {
  return (
    <section className="py-[100px] px-10 bg-gradient-cta relative overflow-hidden">
      {/* Ambient orb */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-[rgba(139,127,168,0.12)] blur-3xl pointer-events-none" />
      ...
      <div className="container-main relative z-10 text-center flex flex-col items-center gap-8">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="font-body text-[14px] text-[rgba(255,255,255,0.5)] max-w-md leading-relaxed"
        >
        ...
        >
          ...
          <a href="https://wa.me/905321234567" target="_blank" rel="noopener noreferrer">
            <PremiumButton variant="ghost" size="lg" className="text-white border-[rgba(255,255,255,0.2)] hover:border-[rgba(255,255,255,0.4)] hover:text-white">
