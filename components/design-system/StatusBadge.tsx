...
const leadStatusConfig: Record<LeadStatus, { label: string; color: string; bg: string }> = {
  new: { label: 'Yeni', color: '#2D5F5D', bg: 'rgba(45,95,93,0.1)' },
  consented: { label: 'Rıza Verildi', color: '#C4A35A', bg: 'rgba(196,163,90,0.1)' },
  ...
  booked: { label: 'Randevu Alındı', color: '#2D5F5D', bg: 'rgba(45,95,93,0.12)' },
